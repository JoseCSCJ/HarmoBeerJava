...
public class Usuario {
	 ...
	 * @param info
	 */
	public Usuario(int id_user, String username, String email, String senha, boolean privilegio, String info) {
	 ...
	 * @param info
	 */
	public Usuario(String username, String email, String senha, boolean privilegio, String info) {
		this.username = username;
		this.email = email;
		this.senha = senha;
		this.privilegio = privilegio;
